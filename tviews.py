...
user_agent = "Mozilla/5.0 (Windows NT 4.0) AppleWebKit/531.2 (KHTML, like Gecko) Chrome/88.0.4172.40 Safari/531.2 Edg/88.01016.8","Mozilla/5.0 (Windows; U; Windows NT 6.0) AppleWebKit/533.35.1 (KHTML, like Gecko) Version/5.0 Safari/533.35.1","Mozilla/5.0 (Macintosh; U; Intel Mac OS X 10_5_1 rv:3.0) Gecko/20191206 Firefox/35.0",
